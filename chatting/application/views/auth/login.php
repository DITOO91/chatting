			...
			<div class="row form_row">
				<div class="col-lg-4 bg-white px-3 py-3" id="form_col">
					<form autocomplete="off" id="form_login">
						<h3 class="text-center">Aplikasi Chatting</h3>
						...
						<div class="field_container">
							...
							<div class="form-group my-0 pt-2 justify-content-end d-flex">
								<div>
									...
									<label for="chkbox1" class="mr-0">Tampilkan Kata Sandi</label>
								</div>
							</div>
							<div class="form-group">
							...
							<h6 class="text-center">Belum punya akun ? <a href="index.php/signup" style="text-decoration:none;">Daftar Sekarang</a></h6>
