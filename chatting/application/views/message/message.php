...
<head>
	...
	<title>Aplikasi Chatting CI</title>
</head>
<body>
	<section id="main" class="bg-dark">
		...
		<div id="chatbox">
			<div id="data_container" class="">
				<div id="bg_image"></div>
				<h2 class="mt-0">Hai ! Selamat Datang Di</h2>
				<h2>Aplikasi Chat </h2>
				<p class="text-center my-2">Hubungkan ke perangkat Anda melalui Internet. Ingatlah bahwa Anda <br> harus memiliki Koneksi Internet yang stabil untuk<br> pengalaman yang lebih besar.</p>
			</div>
				...
				<div id="messageBar" class="py-4 px-4">
					...
					<div id="sendButtonContainer">
						<button class="btn" id="send_message">
							<span class="material-icons">Kirim</span>
						</button>
					</div>
				</div>
			</div>
		...
		<div id="details_of_user">
			...
			<button class="btn btn-danger" id="btn_block">Blokir Pengguna</button>
		</div>
	</section>
	<div id="update_container">
		...
		<form class="" id="form_details" autocomplete="off">
			...
			<div class="form-group">
				...
				<input type="text" maxlength="10" name="txt_phone" placeholder="No ponsel" id="phone_num" class="form-control">
			</div>
			<div class="form-group">
				<label>Alamat</label>
				<input type="text" name="txt_addr" id="address" placeholder="tulisan alamat anda" class="form-control">
			</div>
			<div class="form-group">
				<label>Status</label>
				<textarea name="bio" class="" id="update_bio" placeholder="Status."></textarea>
			</div>
